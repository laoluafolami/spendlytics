    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4">
      <div className="max-w-md w-full">
        ...
        <div className="group relative animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="relative p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-white/20 dark:border-gray-700/50 shadow-2xl space-y-5 sm:space-y-6">
            {error && (
            ...
            {success && (
              <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl flex items-start gap-3">
                ...
                <p className="text-sm text-green-800 dark:text-green-300">Account created successfully! Redirecting...</p>
              </div>
            )}
